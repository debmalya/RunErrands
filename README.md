...
* Task 10: From a directory we have to keep the most latest file, remaining files will be compressed and stored into a specified archive folder. After taking archive all those files will be deleted [TO DO]
